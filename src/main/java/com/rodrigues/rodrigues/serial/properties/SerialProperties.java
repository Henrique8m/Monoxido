...
public class SerialProperties {
    ...
    public SerialProperties(){
    	...
    	pathToProperties = System.getProperty("user.home").toString() + MonoxidoApplication.diretorioStr2 +"\\" + MonoxidoApplication.properties;
	...
	private void createdDiretorioAndFile() {
		...
		try {
			File diretorio1 = new File(System.getProperty("user.home").toString() + MonoxidoApplication.strDiretorioYggDrasil);
			diretorio1.mkdir();
			File diretorio2 = new File(System.getProperty("user.home").toString() + MonoxidoApplication.diretorioStr2);
			diretorio2.mkdir();
			arquivoProperties = new File(diretorio2, MonoxidoApplication.properties );
